...
export const DATA = {
  ...
  events: [
    ...
    },
    {
      ...
      role: "Lead Organizer",
      date: "Nov. 2025",
      location: "Newton School of Technology, Pune",
      description: [
        "Led the organization of a 36-hour hackathon with 300+ participants across 80+ teams from multiple colleges.",
        "Managed end-to-end logistics including sponsorships, judging panels, mentorship sessions, and prize distribution.",
        "Coordinated with industry mentors to provide real-time feedback to participating teams during the event.",
      ],
      tags: ["Hackathon", "Leadership", "Event Management"],
    },
    {
      name: "Systems & Low-Level Workshop",
      role: "Speaker & Instructor",
      date: "Sep. 2025",
      location: "Newton School of Technology, Pune",
      description: [
        "Conducted a hands-on workshop on systems programming and low-level debugging for 60+ students.",
        "Covered topics including memory layout, stack frames, GDB debugging, and writing basic shellcode.",
        "Designed interactive exercises where attendees reverse-engineered small binaries in real-time.",
      ],
      tags: ["Workshop", "Systems Programming", "Teaching"],
    },
  ],
  stats: [
    {
